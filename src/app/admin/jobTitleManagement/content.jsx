  ...
  return (
    <>
      <div className='flex flex-col gap-3 w-full h-full'>
        ...
        <DisplayTable link="/admin/work-experience" click={toggleSidebar} isOpen={isOpen} btnText="Add Job" title="Job Title" array={tableData} col1_Title="Job Title" col2_Title="Created Date" col3_Title="Last Updated" />
      </div>
    </>
  )
}
