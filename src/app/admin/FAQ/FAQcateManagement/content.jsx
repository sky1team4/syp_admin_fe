    ...
    return (
        <>
            <div className='flex flex-col gap-3 w-full h-full'>
                ...
                <DisplayTable click={toggleSidebar} isOpen={isOpen} btnText="Add FAQ Category" title="Q&A Category" array={tableData} col1_Title="Q&A Category" col2_Title="Created Date" col3_Title="Last Updated" />
            </div>
        </>
    )
}
