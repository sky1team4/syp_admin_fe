    ...
    return (
        <>
            <div className='flex flex-col gap-3 w-full h-full'>
                ...
                <SubscriptionSideBar title="Add FAQ Category" dis="lorem ipsum has been the industry's standard." subTitle="FAQ Category" click={toggleSidebar} isOpen={isOpen} />
                <DisplayTable click={toggleSidebar} isOpen={isOpen} btnText="Add Q&A" title="FAQ Category" array={tableData} col1_Title="FAQ Category" col2_Title="Created Date" col3_Title="Last Updated" />
            </div>
        </>
    )
}
