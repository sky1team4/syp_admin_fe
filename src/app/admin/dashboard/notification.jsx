...
const Notifications = ({ isVisible }) => {
  ...
  return (
    <div>
      <div
        className={`notification-panel ${isVisible ? "slide-in" : "slide-out"} relative h-[38rem] z-50 lg:block p-2 sm:p-6 bg-white shadow-md rounded-lg 2xl:w-[20rem] overflow-x-auto custom-scrollbar`}
      >
        {/* Header */}
