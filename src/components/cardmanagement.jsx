...
const Card = ({ title, Icon, link }) => (
  ...
  <div className="bg-white rounded-2xl h-44 w-72 md:w-80 p-4 sm:p-6 flex flex-col justify-center items-center hover:shadow-lg transition-shadow duration-200">
