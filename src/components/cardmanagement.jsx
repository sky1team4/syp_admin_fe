...
const Card = ({ title, Icon, link }) => (
      ...
      <a href={link} title="Go to page">
        <div className="bg-white rounded-2xl h-40 md:h-44 w-[19rem] md:w-80 p-4 sm:p-6 flex flex-col justify-center items-center shadow-lg transition-shadow duration-200">
